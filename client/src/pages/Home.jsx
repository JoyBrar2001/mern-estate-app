    ...
    <main>
      <div className='flex flex-col gap-6 py-28 px-3 max-w-6xl mx-auto'>
        ...
        <div className='text-gray-400 text-xs sm:text-sm'>
          Joy Estate is the best place to find your next place to live.
          <br />
          We have a wide range og properties for you to choose from.
        </div>
        <Link
          to={"/search"}
      ...
      <Swiper navigation>
        {offerListings && offerListings.length > 0 && (
          offerListings.map((listing) => (
            <SwiperSlide key={listing._id} style={{ background: `url(${listing.imageUrls[0]}) center no-repeat`, backgroundSize: 'cover' }}>
